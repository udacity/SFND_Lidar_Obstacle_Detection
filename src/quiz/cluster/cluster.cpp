/* \author Aaron Brown */
// Quiz/Demo and visualization of euclidean clustering on a 2-D points cloud sample (toy data)

#include "cluster.h"
#include "kdtree.h"

#include "../../render/box.h"  // todo add ../../ to include dir in CMakeLists.txt
